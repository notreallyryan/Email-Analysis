# Analyzing Email Interactions

##  NOTE:

The code in this repository is a copy of a group project from CPEN 221. As this was a team project, it is not immediately clear which functions were designed and written by Ryan Choi. Aside from debugging and testing, the main functions written by me are outlined in CONTRIB-moolochi27.md file:
